        ...
        <div className="container">
            <div className='grid md:grid-cols-2 lg:mb-[50px] mb-[30px]'>
                <div className='flex md:justify-end justify-center md:mb-0 mb-[20px] gap-[5px] md:order-2 '>
                    ...
                    <div className='flex items-center justify-center h-[50px] w-[50px] min-w-[50px] bg-primary-color text-white'>
                        <TfiLayoutGrid2 />
                    </div>
                    <div className='h-[50px] w-[50px] min-w-[50px] border border-black/10 flex items-center justify-center'>
                        <GoListUnordered />
                    </div>
                </div>
