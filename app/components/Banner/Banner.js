                ...
                <div className="relative">
                    ...
                    <div className="flex items-center gap-8">
                        <Link href="/" className="flex">
                            <span className="bg-title-color text-white h-[60px] flex items-center justify-center py-[15px] px-[25px]">Start Investing</span>
                            <span className="h-[60px] w-[60px] flex items-center justify-center bg-white"><FiArrowUpRight /></span>
                        </Link>
                    </div>
